...
#### Basic build tools:
```sh
sudo apt-get install -y build-essential git python3 llvm clang gcc-multilib g++-multilib
```

#### Install Android NDK r24 for Linux:
Choose a location where you want to install the Android NDK and run:
```sh
git clone https://github.com/johnnkp/Google_Android_NDK.git
```
...
```sh
git clone https://github.com/johnnkp/nodejs-android.git
cd nodejs-android
git checkout master
```
